	...
	<view>
		<view class="uni-header">
			...
			<view class="uni-group">
				...
				<button class="uni-button" type="default" size="mini" @click="onClickAdd">新增</button>
		...
		<view class="uni-container">
			<unicloud-db ref="udb" :collection="collectionList" field="title,json,component,create_time,update_time"
				...
				<uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
					...
					<uni-tr>
						...
						<uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'json')" sortable
							@sort-change="sortChange($event, 'json')">JSON数据字符串</uni-th>
						<uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'component')" sortable
							@sort-change="sortChange($event, 'component')">自定义组件</uni-th>
...
<script>
	import {
		enumConverter,
		filterToWhere
	} from '../../js_sdk/validator/ly-page.js';
